...
\begin{align}
\ket{\psi} &= \alpha_{\uparrow\uparrow}\ket{\uparrow}\otimes\ket{\uparrow}+\alpha_{\uparrow\downarrow}\ket{\uparrow}\otimes\ket{\downarrow}+\alpha_{\downarrow\uparrow}\ket{\downarrow}\otimes\ket{\uparrow}+\ket{\downarrow}\otimes\ket{\uparrow}).
\end{align}
