...
\end{align}
So we can determine such a state by $M \times N$ numbers $c_{mn}$ here.  If the states are \textit{}not entangled, we can write $\ket{\psi}$ as a product of the individual states:
\begin{align}
