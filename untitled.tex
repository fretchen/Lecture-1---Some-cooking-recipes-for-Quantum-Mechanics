...
\end{itemize} Then work our way into the harmonic oscillator and the hydrogen atom. We will then leave the path of increasingly complex atoms for a moment to have some fun with light-propagagation, lasers and discussion of the Bell inequalities. 
