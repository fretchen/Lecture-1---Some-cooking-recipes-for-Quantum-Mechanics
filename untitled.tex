...
\item We will then leave the path of increasingly complex atoms for a moment to have some fun with light-propaagation, lasers and discussion of the Bell inequalities.
\item
\end{itemize}   
