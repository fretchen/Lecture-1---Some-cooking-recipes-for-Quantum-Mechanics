...
Some good introductions on the traditional approach be found in \cite{2002, 2006} \cite{1}\cite{2}. Previously, we mostly followed the discussion of Ref. \cite{2006}. Nowadays, I also recommend 
