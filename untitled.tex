...
\item \textit{Occupation number of a photon mode}. Any person working on quantum optics has to understand the quantum properties of the This Hilbert space is typically investigated in great detail in quantum optics.
