...
The first step is to identify the right Hilbert space for your problem. Mathematically, it w a complex vector space with elements $\ket{\psi}$ and a Hermitian scalar product
\begin{align}
