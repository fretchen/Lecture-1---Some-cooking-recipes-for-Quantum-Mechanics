...
The first step is to identify the right Hilbert space for your problem. For a classical problem, we would simply list all the different possible outcomes in a list $(p_1, \cdots, p_N)$ of . As one of the outcomes has to happen, we obtain the normalization condition:
\begin{align}
\sum_i p_i = 1
\end{align}
