...
Aaronson claims that this is just measuring probabilities in in $L_2$ norm. I would highly recommend his discussions on his blog for a more instructive derivation\cite{quantum}. Next we will not use the traditional lists, but the bra-ket notation, 
