...
And given that these are complex vectors, we will measure their ovrMathematically, it will be a complex vector space with elements $\ket{\psi}$ and a Hermitian scalar product
\begin{align}
