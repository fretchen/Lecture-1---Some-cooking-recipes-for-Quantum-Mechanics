...
In certain cases one would have to have access to relativistic dynamics, which are then described by the \textbf{Dirac equation}. However, we will only touch on this topic very briefly
