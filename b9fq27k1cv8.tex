...
\begin{itemize}
\item To measure the \textit{orbit} we typically perform spectroscopy.
\item For the \textit{occupation number} we have nowadays number counting photodectors.
\item The \textit{position of an atom might be detected through high-resolution CCD cameras.CCD camera
