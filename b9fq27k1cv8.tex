...
\begin{enumerate}
\item The operator to be tested is the position operator of the electron bound to the nucleus. We access To measure the orbit we typically perform spectroscopy.
