\subsection{Observables and Measurements}A given physical quantity $A$ is associated with a Hermitian operator $\hat{A}$ \index{Hermitian operator} acting in the Hilbert space \index{Hilbert space} of the system.
