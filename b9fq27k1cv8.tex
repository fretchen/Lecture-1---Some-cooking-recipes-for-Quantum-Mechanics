...
\begin{enumerate}
\item In atoms the operators will be angular moment, radius, vibrations etc.The operator to be tested is the position operator of the electron bound to the nucleus. We access it indirectly through spectroscopy.
